...
const BTCAssetID = "965e5c6e-434c-3fa9-b780-c50f43cd955c"
...
func fetchBalance() {
	...
	asset_id := []string{"965e5c6e-434c-3fa9-b780-c50f43cd955c", "66152c0b-3355-38ef-9ec5-cae97e29472a", "8b4d8b7d-175b-36f8-867d-7e3cd760fa5b"}
	for _, v := range asset_id {
		asset, err := mixin.ReadAsset(ctx, accessToken, v)
		if err != nil {
			log.Panic(err)
			return
		}
